...
class Tooltip extends Element {
  ...
  update(changed, replay) {
    ...
    if (!active.length) {
      ...
      const position = positionors[options.position].call(me, active, me._eventPosition);
  ...
  _updateAnimationTarget(options) {
    ...
    if (animX || animY) {
      const position = positionors[options.position].call(me, me._active, me._eventPosition);
      if (!position) {
        return;
      }
      const size = me._size = getTooltipSize(me, options);
  ...
  _positionChanged(active, e) {
    ...
    const position = positionors[options.position].call(this, active, e);
    return position !== false && (caretX !== position.x || caretY !== position.y);
  }
}
Tooltip.positionors = positionors;
var plugin_tooltip = {
  id: 'tooltip',
  _element: Tooltip,
  positionors,
