...
(function($, window){
    ...
    */
    window.stroyka.sidebar = (function() {
        ...
        // onmoueover to sidebar hover and not mouseover to sidebar hover

        $('.sa-app__sidebar').on('mouseover', function() {
            $('.sa-app').addClass('sidebar-show');
            $('.sa-app--desktop-sidebar-hidden .sa-nav__title').css('display','block');
            $('.sa-app--desktop-sidebar-hidden .sa-nav__section-title').css('display','block');
            $('.sa-sidebar-logo').css('display','block');
            $('.sa-sidebar-logo-narrow').css('display','none');
        });

        //not mouseover to sidebar hover
        $('.sa-app__sidebar').on('mouseleave', function() {
            $('.sa-app').removeClass('sidebar-show');
            $('.sa-app--desktop-sidebar-hidden .sa-nav__title').css('display','none');
            $('.sa-app--desktop-sidebar-hidden .sa-nav__section-title').css('display','none');
            $('.sa-app--desktop-sidebar-hidden .sa-sidebar-logo').css('display','none');
            $('.sa-sidebar-logo-narrow').css('display','block');
        });
        ...
        return {
            toggle: function(value) {
                ...
                if (newState) {
                    ...
                    $('.sa-app--desktop-sidebar-shown .sa-nav__title').css('display','block');
                    $('.sa-app--desktop-sidebar-shown .sa-nav__section-title').css('display','block');
                    $('.sa-sidebar-logo').css('display','block');
                    $('.sa-sidebar-logo-narrow').css('display','none');
                } else {
                    ...
                    $('.sa-app--desktop-sidebar-hidden .sa-nav__title').css('display','none');
                    $('.sa-app--desktop-sidebar-hidden .sa-nav__section-title').css('display','none');
                    $('.sa-sidebar-logo').css('display','none');
                    $('.sa-sidebar-logo-narrow').css('display','block');
                }
            },
            open: function() {
        ...
        const stroykaQuill = {
            init: function(element) {
                ...
                quill.on('text-change', function() {
                    ...
                    /*document.getElementById("address_data").value = quill.root.innerHTML;*/
                });
