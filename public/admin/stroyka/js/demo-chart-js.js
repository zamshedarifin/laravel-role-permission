...
const rateDataPie1 = {
    labels: ['Fund Release', 'Fund Recovery'],
    datasets: [
        {
            backgroundColor: [
                '#3F93D0',
...
*/
(function() {
    const chartCanvas = document.getElementById('example-chart-js-pie1');
...
(function() {
    const chartCanvas = document.getElementById('example-chart-js-pie2');
